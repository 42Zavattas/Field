...
exports.getAll = function (req, res, next) {
	...
	if (req.query.toUser) {
		return Field.find({ 'corrections.targetName': req.user.login, 'corrections.dueDate': { $ne: null } }, 'user slots -_id')
