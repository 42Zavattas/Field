		...
		.exec(function (err, field) {
			...
			if (field.user.memo !== -1) {
				...
				mailOptions.html =
					...
					'</div><div style="padding-top: 40px; color: white; font-size: 13px;"><hr>Have a good day,<br>The Field Team.</div>';

				var sendTime = moment(currentSlot.date).utc().subtract('minutes', field.user.memo).format('YYYY-MM-DD HH:mm:SS');
